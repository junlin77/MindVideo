...
from src.MindVideo.pipelines.pipeline_mindvideo import MindVideoPipeline
from src.MindVideo.utils import save_videos_grid, ddim_inversion
...
def main(
    pretrained_model_path: str = "/content/drive/MyDrive/neurips-release/pretrains/sub1",
    output_dir: str,
    data_path: str = "/content/drive/MyDrive/neurips-release/wen2017",
    wen_subs: ['subject1']
    train_data: Dict,
    ...
    *_, config = inspect.getargvalues(inspect.currentframe())
    ...
    train_dataset, test_set = create_Wen_dataset(path=config.wen_path, patch_size=config.patch_size, 
    ...
    validation_pipeline = MindVideoPipeline(
    ...
    if accelerator.is_main_process:
        ...
        pipeline = MindVideoPipeline.from_pretrained(
